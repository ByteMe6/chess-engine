...
- ✅ **Рокіровка шахів Фішера (960)** — король і тури можуть стартувати будь-де на першій горизонталі; рокіровка ходом «король бере свою туру», підтримуються права у форматі Shredder-FEN (`HAha`)
